...
# draw acc loss figure
    ...
    plt.savefig('/home/dell/exs/NASA/log_records/RSSCN7Accu.eps', dpi=128)# need to be changed
    plt.show()
    plt.figure()
    ...
    plt.xticks(fontsize=18)
    plt.yticks(fontsize=18)
    plt.savefig('/home/dell/exs/NASA/log_records/6classRGBLoss.eps', dpi=128)# need to be changed
