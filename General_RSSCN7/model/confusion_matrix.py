...
for x_val, y_val in zip(x.flatten(), y.flatten()):
    ...
    if (c > 0.01):
        plt.text(x_val, y_val, "%0.1f" %(c,), color='blue', fontsize=17, va='center', ha='center')
# offset the tick
...
plt.savefig('confusion_matrix.jpg', dpi=120)
plt.savefig('confusion_matrix.eps', dpi=120)
